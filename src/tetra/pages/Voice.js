...
export default function Voice() {
    ...
    "프리미엄": [
        ...
        { title: "기쁨_1", text: "기뻐요. 오늘 일을 다이어리에 적어놔야겠어요!" },
        { title: "기쁨_2", text: "저... 편지를 보내도 되는지 여쭤봐도 될까요?" },
    ...
    "기본": [
        ...
        { title: "도움 요청_1", text: "변수가 과다해요!" },
        { title: "도움 요청_2", text: "즉시 보강해야 해요!" },
        ...
        { title: "감탄_1", text: "기대 이상이에요!" },
        { title: "감탄_2", text: "패턴과 규칙성이 인상적이네요!" },
        { title: "고마움_1", text: "덕분에 보완되었어요." },
        { title: "고마움_2", text: "결과가 명확해졌네요!" },
        { title: "APC를 불러낼 때", text: "저보다 더 잘 하시잖아요." },
    ],
    "스킬": [
        { title: "존재 비율_1", text: "거기까지!" },
        { title: "존재 비율_2", text: "어딜!" },
        { title: "마멸_1", text: "견제, 터져라!" },
        { title: "마멸_2", text: "방어, 폭발!" },
        { title: "예각_1", text: "날카롭게!" },
        { title: "예각_2", text: "갈라져라!" },
    ...
    "퀵보이스": [
        { title: "공격", text: "관측 완료, 이제 검증 단계예요." },
        { title: "후퇴", text: "탐구할 때가 아니에요. 안정화가 우선이에요!" },
        { title: "트루퍼 대기", text: "미승인이예요. 아직 관찰이 필요해요!" },
        { title: "트루퍼 공격", text: "승인났어요. 빠르게 파괴하죠!" },
        { title: "기지 방어", text: "기지에 리스크가 확인되었어요!" },
